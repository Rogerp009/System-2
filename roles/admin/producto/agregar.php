...
<div class="page-container"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->	
	...
	<div class="main-content">
		...
		<hr />
			<ol class="breadcrumb bc-3">
				...
				<li class="active">
					<a href="Agregar.php"><i class="entypo-cup"></i>Producto - Agregar</a>
				</li>				
			</ol>	
		...
		<section class="panel">
			<div class="panel panel-success" data-collapsed="0">	
				...
				<div class="panel-body">				
					...
					<div class="row">
						<div class="col-xs-12">					
							<blockquote style="color:red;">Importante! Unidades por Caja.</blockquote>
							<div class="col-xs-4">
								<h4>330 ml, 500 ml, 600 ml - 24 unidades.</h4>
							</div>
							<div class="col-xs-4">
								<h4>1500 ml - 12 unidades.</h4>
							</div>	
							<div class="col-xs-4">
								<h4>5000 ml - 4 unidades.</h4>
							</div>													
						</div>
					</div>			
				</div>				
								...
								<div class="panel-body">								
									<form role="form" id="form_registrar" class="form-horizontal form-groups-bordered validate" method="POST">
										...
										<div class="form-group">
											...
											<div style="margin-top:7px;" id="error_nombre"></div>
										</div>																	
										...
										<div class="form-group">
											...
											<div class="col-sm-5">
												<input onkeyup="var pattern = /[^0-9\.]/g; this.value = this.value.replace(pattern, '');" data-toggle="popover" data-trigger="hover" data-placement="top" data-content="Los precio que coloque a los producto es por unidad. Arriba puede ver las unidades por caja." data-original-title="Importante!" type="text" class="form-control" id="precio" name="precio" data-validate="required" data-message-required="Campo no puede estar vacio.">
											</div>
										</div>
	...
	<script src="../../../assets/js/jquery-1.10.2.min.js"></script>		
	<script src="../../../custom_assets/js/custom_producto.js"></script>
