...
<head>
	...
	<title>Camión | Administrador </title>
...
<div class="page-container"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->	
	...
	<div class="main-content">
		...
		<hr />
			<ol class="breadcrumb bc-3">
				...
				<li class="active">
					<a href="administrador.php"><i class="entypo-popup"></i>Camión</a>
				</li>				
			</ol>
		...
		<section class="panel_report" id=""><!-- Area de reportes-->
			<div class="panel panel-success" data-collapsed="0">	
				...
				<div class="panel-heading">
					<div class="panel-title">Registrar Camión</div>				
				</div>			
				<!-- panel body -->
				<div class="panel-body">				
					<p>Panel donde puede registrar los camiones.</p>			
				</div>				
			</div>
			<br />
			<div class="row">
								...
								<div class="panel-body">								
									<form role="form" id="form_registrar" class="form-horizontal form-groups-bordered validate" method="POST">
										...
										<div class="form-group">
											...
											<div class="col-sm-5">
												<input type="text" class="form-control" id="matricula" name="matricula" data-validate="required" data-message-required="Campo no puede estar vacio.">
											</div>
	                                        <div class="col-xs-3">
	                                            <div id="error_matricula"><!-- Mesanje si esta registrado--></div>
										...
										<div class="form-group" id="form_cedula">
											<label for="field-3" class="col-sm-3 control-label">Marca</label>										
											<div class="col-sm-5">
												<input type="text" class="form-control" id="marca" name="marca" data-validate="required" data-message-required="Campo no puede estar vacio.">
											</div>										
										</div>
										
			                            <!-- Telefono -->                            
			                            <div class="form-group">
											<label for="field-3" class="col-sm-3 control-label">Modelo</label>		                            
			                                <div class="col-sm-5">
			                                   <input type="text" class="form-control" id="modelo" name="modelo" data-validate="required" data-message-required="Campo no puede estar vacio.">
			                                </div>
			                           	</div>								 
	...
	<script src="../../custom_assets/js/custom_camion.js"></script>
