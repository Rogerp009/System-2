...
<?php
	...
	if($_SESSION["user_name"] != ""){ 
		$queryOrden = mysql_query("SELECT * FROM orden_compra O WHERE O.cedula_cliente = $cedula");
...
?>
	<section>				
		<div class="">
			<div class="alert alert-info"><strong>Importante!</strong> Puedes ver tu listado de pedido para poder por pagar para su liberación.</div>
		</div>	
